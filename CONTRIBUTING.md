# Contributing to Crudo

Thanks for helping improve Crudo. This repository is a Rust-first CLI
...
`SKIP_CRUDO_PRE_PUSH_BUILD=1`; the hook still runs the ROADMAP guard and prints
