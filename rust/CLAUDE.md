...
This file provides guidance to Crudo (crudo.dev) when working with code in this repository.
...
- Keep shared defaults in `.crudo.json`; reserve `.crudo/settings.local.json` for machine-local overrides.
