...
pub const REPORT_SCHEMA_V1: &str = "crudo.report.v1";
pub const DEFAULT_PROJECTION_POLICY_V1: &str = "crudo.report.projection.v1";
...
mod tests {
    ...
    fn capability_negotiation_omits_unsupported_field_families() {
        ...
        let projection = project_report(&report, &capabilities, "legacy_crudohip");
