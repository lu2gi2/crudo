//! Core runtime primitives for the `crudo` CLI and supporting crates.
//!
...
pub use config::{
    ...
    RuntimeProviderConfig, ScopedMcpServerConfig, CRUDO_SETTINGS_SCHEMA_NAME,
};
...
pub use stale_base::{
    check_base_commit, format_stale_base_warning, read_crudo_base_file, resolve_expected_base,
