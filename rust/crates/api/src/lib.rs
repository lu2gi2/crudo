...
pub use types::{
    AttachmentKind, AttachmentValidationError, ContentBlockDelta, ContentBlockDeltaEvent,
    ...
    MultimodalAttachment, OutputContentBlock, StreamEvent, ToolChoice, ToolDefinition,
