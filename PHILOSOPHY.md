...
The Python rewrite was a byproduct. The Rust rewrite was also a byproduct. The real thing worth studying is the **system that produced them**: a crudohip-based coordination loop where humans give direction and autonomous crudos execute the work.

Crudo is not just a codebase. It is a public demonstration of what happens when:
...
A person can type a sentence from a phone, walk away, sleep, or do something else. The crudos read the directive, break it into tasks, assign roles, write code, run tests, argue over failures, recover, and push when the work passes.

That is the philosophy: **humans set direction; crudos perform the labor.**

## The Three-Part System

### 1. OmX (`oh-my-codex`)
OmX provides the workflow layer.
...
### 2. crudohip
crudohip is the event and notification router.
...
OmO handles multi-agent coordination.
...
## What Crudo Demonstrates

Crudo demonstrates that a repository can be:

- **autonomously built in public**
- coordinated by crudos/lobsters rather than human pair-programming alone
...
**Crudo is a demo of autonomous software development.**

Humans provide direction.
Crudos coordinate, build, test, recover, and push.
